...
def calculate_mAP(det_boxes, det_labels, det_scores, true_boxes, true_labels, true_difficulties, n_classes = 21):
    ...
    for c in range(1, n_classes):
        ...
        #print(det_images.shape,det_labels.shape)
        ...
        # print(Elan_od_rev_label_map[c], len(true_class_difficulties), n_easy_class_objects, n_class_detections, torch.mean(true_class_boxes,dim=0))
